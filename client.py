...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2 + 10, y=screen_height/2 -160)
...
def gameWindow():
    ...
    finishingBox()
    global roleButton
    rollButton = Button(gameWindow,text="ROLL DICE",fg="black",font=("Chalkboard SE",15),command=rollDice, bg="grey", width=20,height=5)
